...
void		builtins_do(t_envlist **list, t_cmds *cmds, t_shell **shell, char **envp);
...
void	left_redir(t_redirs *elem, t_shell **shell);
void	right_redir(t_redirs *elem, t_shell **shell);
