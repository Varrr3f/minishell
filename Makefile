SRCS	=	excve_pipes.c get_cmd_args.c builtins.c signal1.c clear_commands_array.c utils_funcs1.c\
			utils_funcs2.c get_command_information.c get_command_position.c get_total_commands_validate_line.c\
			here_doc.c minishell.c parser.c parse_path.c pipes.c readline_prompt.c redirects.c\
